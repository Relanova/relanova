...
const WhatsAppButton = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-primary hover:bg-secondary text-primary-foreground shadow-lg hover:shadow-xl flex items-center justify-center transition-all hover:-translate-y-1 group"
