  ...
  <Html lang="nl" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Je bent uitgenodigd om deel uit te maken van{' '}
          <Link href={siteUrl} style={link}>
            <strong>{siteName}</strong>
          </Link>
          . Klik op de knop hieronder om de uitnodiging te aanvaarden en je
        ...
        <Text style={footer}>
          Verwachtte je deze uitnodiging niet? Dan kan je deze e-mail negeren.
        </Text>
      </Container>
    </Body>
  </Html>
